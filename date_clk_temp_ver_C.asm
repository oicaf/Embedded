...
;
; wersja C:
; - tryb edycji kasuje ekran, wyswietla w pierwszej kolejnosci tylko rok i po zakonczeniu wprowadzania zmian kolejne wcisniecie S1(SET) dolacza miesiac itd.
; - wyswietlanie sekund
...
MOV	A,#'-'
ACALL	write_char
CJNE	R5,#1,norm16	;jesli R5=1 to edycja lat
ACALL	home
AJMP	main
norm16:
...
MOV	A,#'-'
ACALL	write_char
CJNE	R5,#2,norm26	;jesli R5=2 to edycja miesiecy
ACALL	home
AJMP	main
norm26:
...
ADD	A,#30h		;wg tabeli ASCII cyfry od 0 do 9 to 30h + (0-9)h
ACALL	write_char
CJNE	R5,#3,norm315	;jesli R5=3 to edycja dni
ACALL	home
AJMP	main
norm315:
...
main1:
CJNE	R5,#4,norm44	;jesli R5=4 to edycja dni tygodnia
ACALL	home
AJMP	main
norm44:
...
MOV	A,#':'
ACALL	write_char
CJNE	R5,#5,norm58	;jesli R5=5 to edycja godzin
ACALL	home
AJMP	main
norm58:
...
MOV	A,#':'
ACALL	write_char
CJNE	R5,#6,norm660	;jesli R5=6 to edycja minut
ACALL	home
AJMP	main
norm660:
...
ADD	A,#30h		;wg tabeli ASCII cyfry od 0 do 9 to 30h + (0-9)h
ACALL	write_char
CJNE	R5,#7,norm73	;jesli R5=7 to edycja sekund
ACALL	home
AJMP	main
norm73:
