...
CJNE	R5,#4,norm50	;jesli R5=4 to edycja godzin
...
ACALL	write_char
sec1:
CJNE	R5,#4,norm58	;jesli R5=4 to edycja godzin
ACALL	home
AJMP	main
norm58:
...
CJNE	R5,#5,norm69	;jesli R5=5 to edycja minut
...
ADD	A,#30h		;wg tabeli ASCII cyfry od 0 do 9 to 30h + (0-9)h
ACALL	write_char
CJNE	R5,#5,norm660	;jesli R5=5 to edycja minut
ACALL	home
AJMP	main
norm660:
